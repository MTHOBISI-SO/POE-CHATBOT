...
namespace Cybersecurity_Awareness_Bot
{
    public partial class MainWindow : Window
    {
        ...
        private string GenerateBotResponse(string userInput)
        {
            ...
            {
                return $"I'm not human I dont feel, {_userName}. However, I am ready to help you with cybersecurity awareness.";
            }
            ...
            if (input.Contains("what's your purpose") || input.Contains("what is your purpose"))
            {
                return "My purpose is to teach users about common cyber threats,\n" +
                       "guide them on a safe online path\n" +
                       "reduce the chances of cyber attacks.";
            }

            if (input.Contains("what can i ask you about"))
            {
                return "Ask about password related questions,\n" +
                       "phishing scams\n" +
                       "online protection.";
            }
            ...
            if (input.Contains("password"))
            {
                ...
                return "Password protects whatever is inside the system or file that is locked. \n" +
                        "A strong password should have strong characters " +
            ...
            if (input.Contains("phishing"))
            {
                ...
                return "Phishing is where a user gives away sensitive information to wrong people \n" +
                       "passwords or bank details by pretending to be a trusted source. This is usually done through messages, \n" +
                       "websites that look real.\n" +
                       "Some signs of phishing:\n" +
                       "-Messages asking for your personal details.\n" +
            ...
            if (input.Contains("safe browsing") || input.Contains("browse safely") || input.Contains("browsing"))
            {
                ...
                return "Safe browsing means using the internet in a way that protects your personal information from scammers\n" +
            ...
            return "I dont get it. Make me understand? You can ask about passwords, phishing, or safe browsing.";
        }
    }
