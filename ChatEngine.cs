    ...
    public class ChatEngine
    {
        ...
        public string ProcessInput(string userInput)
        {
            ...
            if (lowerInput.Contains("my name is"))
            {
                ...
                return $"Great to meet you, {name}! What cybersecurity topic would you like to talk about?";
            }
            ...
            if (lowerInput.Contains("explain more") || lowerInput.Contains("give me another tip") || lowerInput.Contains("tell me more"))
            {
                ...
                return "We can talk about passwords, scams, or network privacy. Which one is giving you a hard time?";
            }
